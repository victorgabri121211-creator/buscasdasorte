...
const MODULE_CATEGORIES = [
  ...
  },
  {
    ...
    modules: [
      ...
      { key: 'foto-ma', title: 'FOTO (BASE MA)' },
      { key: 'foto-ro', title: 'FOTO (BASE RO)' },
      { key: 'foto-mg', title: 'FOTO (BASE MG)' },
      { key: 'foto-ba', title: 'FOTO (BASE BA)' },
      { key: 'foto-rj', title: 'FOTO (BASE RJ)' },
      { key: 'foto-pr', title: 'FOTO (BASE PR)' },
      { key: 'foto-sc', title: 'FOTO (BASE SC)' },
      { key: 'foto-rs', title: 'FOTO (BASE RS)' },
      { key: 'foto-go', title: 'FOTO (BASE GO)' },
      { key: 'foto-am', title: 'FOTO (BASE AM)' },
      { key: 'foto-ce', title: 'FOTO (BASE CE)' },
      { key: 'foto-mt', title: 'FOTO (BASE MT)' },
      { key: 'foto-al', title: 'FOTO (BASE AL)' },
      { key: 'foto-ac', title: 'FOTO (BASE AC)' },
      { key: 'foto-ap', title: 'FOTO (BASE AP)' },
      { key: 'foto-pa', title: 'FOTO (BASE PA)' },
      { key: 'foto-pi', title: 'FOTO (BASE PI)' },
      { key: 'foto-rn', title: 'FOTO (BASE RN)' },
      { key: 'foto-pb', title: 'FOTO (BASE PB)' },
      { key: 'foto-se', title: 'FOTO (BASE SE)' },
      { key: 'foto-to', title: 'FOTO (BASE TO)' },
      { key: 'foto-rr', title: 'FOTO (BASE RR)' },
      { key: 'foto-ms', title: 'FOTO (BASE MS)' },
      { key: 'foto-es', title: 'FOTO (BASE ES)' },
      { key: 'foto-df', title: 'FOTO (BASE DF)' },
    ],
  },
  {
    title: 'NOME & VÍNCULOS',
